...
while "nocollision"=="nocollision": #Loop that runs infintely on this case
    rate(100)
    time = time + 1
    Mtrue = 2*pi/period*(time) + M
    Etrue = solvekepasteroid(Mtrue)
    Mtruee = 2*pi/periode*(time) +Me  #True mass of earth
    Etruee= solvekepEarth(Mtruee)     #True E of earth
